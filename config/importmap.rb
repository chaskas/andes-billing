pin "application-billing", to: "billing/application.js", preload: true
...
pin_all_from Billing::Engine.root.join("app/javascript/billing/controllers"), under: "controllers", to: "billing/controllers"